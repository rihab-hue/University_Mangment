...
const Editnote = () => {
    ...
    const editNote = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`http://localhost:8082/actualites/update/${id}`, note);
                            ...
                            <div className="p-3 rounded w-50 border">
                                ...
                                <form onSubmit={(e) => editNote(e)} className="my-form">
                                    ...
                                    <div className="form-group mb-3">
                                        ...
                                        <select name="titre" value={titre} onChange={(e) => handleInputChange(e)} className="form-control rounded-0">
                                    ...
                                    <div className="form-group mb-3">
                                        ...
                                        <input type="boolean" name="statut" value={statut} placeholder="Entrer la note" onChange={(e) => handleInputChange(e)} className="form-control rounded-0" required />
                                    </div>
                                    <div className="form-group mb-3">
                                        <label htmlFor="matiere"><strong>Cours</strong></label>
                                        <select name="contenu" value={contenu} onChange={(e) => handleInputChange(e)} className="form-control rounded-0">
