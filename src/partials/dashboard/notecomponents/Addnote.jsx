...
const AddNote = () => {
    ...
    const { titre, statut, contenu } = note;
    ...
    const saveNote = async (e) => {
        e.preventDefault();
        try {
            await axios.post("http://localhost:8082/actualites", note);
                            ...
                            <div className="p-3 rounded w-50 border">
                                ...
                                <form onSubmit={(e) => saveNote(e)} className="my-form">
                                    ...
                                    <div className="form-group mb-3">
                                        ...
                                        <select name="titre" value={titre} onChange={(e) => handleInputChange(e)} className="form-control rounded-0" required>
                                    ...
                                    <div className="form-group mb-3">
                                        <label htmlFor="contenu"><strong>Cours</strong></label>
                                        <select name="contenu" value={contenu} onChange={(e) => handleInputChange(e)} className="form-control rounded-0" required>
                                    ...
                                    <div className="form-group mb-3">
                                        ...
                                        <input type="boolean" name="statut" value={statut} placeholder="Enter note" onChange={(e) => handleInputChange(e)} className="form-control rounded-0" required />
                                    </div>
